...
<input type="hidden" name="categoryLevel3Id" value="${parame }"/>
...
<div class="i_bg">
    ...
    <div class="content">
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="images/p_big.jpg" title="Images" class="MagicZoom" id="MagicZoom"><img
                    src="${pageContext.request.contextPath }/images/${requestScope.product.fileName }" width="390"
                    height="390"/></a></div>
                ...
                <div id="tsImgSCon">
                    <ul>
                        <li onclick="showPic(0)" rel="MagicZoom" class="tsSelectImg"><img
                                src="${pageContext.request.contextPath }/images/${requestScope.product.fileName }"
                                tsImgS="images/ps1.jpg" width="79" height="79"/></li>
                        <li onclick="showPic(1)" rel="MagicZoom"><img
                                src="${pageContext.request.contextPath }/images/${requestScope.product.fileName }"
                                tsImgS="images/ps2.jpg" width="79" height="79"/></li>
                        <li onclick="showPic(2)" rel="MagicZoom"><img
                                src="${pageContext.request.contextPath }/images/${requestScope.product.fileName }"
                                tsImgS="images/ps3.jpg" width="79" height="79"/></li>
                        <li onclick="showPic(3)" rel="MagicZoom"><img src=".././images/ps4.jpg" tsImgS="images/ps4.jpg"
                                                                      width="79" height="79"/></li>
                        <li onclick="showPic(4)" rel="MagicZoom"><img src=".././images/ps1.jpg" tsImgS="images/ps1.jpg"
                                                                      width="79" height="79"/></li>
                        <li onclick="showPic(5)" rel="MagicZoom"><img src=".././images/ps2.jpg" tsImgS="images/ps2.jpg"
                                                                      width="79" height="79"/></li>
                        <li onclick="showPic(6)" rel="MagicZoom"><img src=".././images/ps3.jpg" tsImgS="images/ps3.jpg"
                                                                      width="79" height="79"/></li>
                        <li onclick="showPic(7)" rel="MagicZoom"><img src=".././images/ps4.jpg" tsImgS="images/ps4.jpg"
                                                                      width="79" height="79"/></li>
                    </ul>
                </div>
        ...
        <div class="pro_des">
            ...
            <div class="des_price">
                本店价格：<b>￥<span><fmt:formatNumber pattern="0.00" value="${ requestScope.product.price }"
                                                 maxFractionDigits="2" type="text"></fmt:formatNumber></span> </b><br/>
                消费积分：<span>28R</span>
            </div>
            ...
            <div class="des_join">
                ...
                <span class="fl"><a onclick="ShowDiv_1('MyDiv1','fade1',${product.id })"><img
